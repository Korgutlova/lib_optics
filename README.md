...
<p>Для проведения вычислений и построения графиков необходимо указать высоту объекта — height_subject.
  Все остальные данные, а также график строятся на основании этих входных данных.</p>
